        ...
        <BrowserRouter>
          ...
          <main>
            <Routes>
              ...
              <Route path="/services/digital-payments" element={<div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900"><div className="text-center"><h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-4">Digital Payments Service</h1><p className="text-gray-600 dark:text-gray-400">Coming Soon - Digital Payment & Customer Payment Solutions</p></div></div>} />
